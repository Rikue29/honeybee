-- Create a public bucket for community content
insert into storage.buckets (id, name, public) 
values ('community_content', 'community_content', true);

-- Enable RLS
alter table storage.objects enable row level security;

-- Create policies for the community_content bucket
create policy "Community content is publicly accessible"
on storage.objects for select
using ( bucket_id = 'community_content' );
